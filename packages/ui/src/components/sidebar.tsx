...
import { Separator } from "@trackfi/ui/components/separator"
import {
  Sheet,
  SheetContent,
  SheetDescription,
      ...
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        ...
        >
          <SheetHeader className="sr-only">
            <SheetTitle>{text.sidebarTitle}</SheetTitle>
            <SheetDescription>{text.sidebarDescription}</SheetDescription>
          </SheetHeader>
...
function SidebarTrigger({
  ...
  return (
    ...
    >
      <PanelLeftIcon />
      <span className="sr-only">{text.toggleSidebar}</span>
    </Button>
  )
}
