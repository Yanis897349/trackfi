/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 5189fc90b58650030ff9cd0a963407b7)
...
interface __BaseEnv_CloudflareBindings {
	...
	APP_ORIGIN: "https://trackfi-web.pages.dev";
	AUTH_BASE_URL: "https://trackfi-api.trackfi-api.workers.dev";
	EMAIL_FROM: "Trackfi <hello@yanis-kernoua.dev>";
	ADMIN_EMAILS: "trackfi-web.pages.de.contend323@passmail.net";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ORIGIN" | "AUTH_BASE_URL" | "EMAIL_FROM" | "ADMIN_EMAILS" | "BETTER_AUTH_SECRET" | "BRANDFETCH_CLIENT_ID" | "RESEND_API_KEY" | "TURNSTILE_SECRET_KEY">> {}
}
